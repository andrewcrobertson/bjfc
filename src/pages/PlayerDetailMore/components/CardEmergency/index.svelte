<script lang="ts">
  ...
  const { initials, name, phone1, phone2, relationship, gender } = contact;
...
<div class={rootClass}>
  <div class="border border-gray-300 p-4 lg:p-6">
    ...
    <div class="flex flex-col -mb-3">
      ...
      <div class="mb-2 cursor-default px-6 py-3 inline-flex items-center text-sm border border-gray-300 border-dotted">&nbsp;</div>
    </div>
  </div>
</div>
